...
@Component({
  selector: 'app-branch-certificate',
  templateUrl: './branch-certificate.component.html',
  styleUrls: ['./branch-certificate.component.css']
})
export class BranchCertificateComponent implements OnInit {
  modalRef: BsModalRef;
  message: string;
