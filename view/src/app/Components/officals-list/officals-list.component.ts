...
@Component({
  selector: 'app-officals-list',
  templateUrl: './officals-list.component.html',
  styleUrls: ['./officals-list.component.css']
})
export class OfficalsListComponent implements OnInit {
