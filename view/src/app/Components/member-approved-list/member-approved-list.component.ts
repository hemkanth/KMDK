...
@Component({
  selector: 'app-member-approved-list',
  templateUrl: './member-approved-list.component.html',
  styleUrls: ['./member-approved-list.component.css']
})
export class MemberApprovedListComponent implements OnInit {
