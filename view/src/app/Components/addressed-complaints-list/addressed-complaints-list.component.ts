...
@Component({
  selector: 'app-addressed-complaints-list',
  templateUrl: './addressed-complaints-list.component.html',
  styleUrls: ['./addressed-complaints-list.component.css']
})
export class AddressedComplaintsListComponent implements OnInit {
