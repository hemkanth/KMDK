...
@Component({
  selector: 'app-registered-complaints-list',
  templateUrl: './registered-complaints-list.component.html',
  styleUrls: ['./registered-complaints-list.component.css']
})
export class RegisteredComplaintsListComponent implements OnInit {
