...
@Component({
  selector: 'app-member-idcard-print',
  templateUrl: './member-idcard-print.component.html',
  styleUrls: ['./member-idcard-print.component.css']
})
export class MemberIdcardPrintComponent implements OnInit {
